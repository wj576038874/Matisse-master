...
public class MatisseActivity extends AppCompatActivity implements
        AlbumCollection.AlbumCallbacks, MediaSelectionFragment.SelectionProvider, View.OnClickListener,
    ...
    private RecyclerView recycleViewAlbums;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recycleViewAlbums = bsdFolderDialogView.findViewById(R.id.rv_folder);

        tvSelectedAlbum.setOnClickListener(v -> openFolder());
    }
    ...
    public void onAlbumLoad(final Cursor cursor) {
        ...
        if (!albumList.isEmpty()) {
            recycleViewAlbums.setLayoutManager(new LinearLayoutManager(this));
            AlbumsAdapter adapter = new AlbumsAdapter(this, albumList);
            adapter.setOnFolderSelectListener(album -> {
                onAlbumSelected(album);
                bottomSheetDialog.dismiss();
            });
            recycleViewAlbums.setAdapter(adapter);
        }
    ...
    private void onAlbumSelected(Album album) {
        if (album.isAll() && album.isEmpty()) {
            ...
            tvSelectedAlbum.setText(album.getDisplayName(this));
