...
public final class SelectionCreator {
     ...
     *
     * 只有当{@link SelectionSpec#mediaTypeExclusive}设置为true且您希望设置不同的最大值时才有用
     * *可选择的文件的图像和视频媒体类型。
     *
     ...
     *
     * 是否启用拍照 必须设置 {@link #captureStrategy}
     *
     ...
     *
     * 预览图片的时候  是否启用触摸影藏toolBar和bottomBar
     *
     * @param enable false
     * @return {@link SelectionCreator} for fluent API.
     */
     ...
     *
     * 屏幕旋转
     * {@link android.content.pm.ActivityInfo#SCREEN_ORIENTATION_LANDSCAPE}.固定竖屏
     * {@link android.content.pm.ActivityInfo#SCREEN_ORIENTATION_PORTRAIT}.固定横屏
     * {@link android.content.pm.ActivityInfo#SCREEN_ORIENTATION_USER}.根据手机重力自动横竖切换感应
     *
     ...
     *
     * gridLayoutManager 的spanCount 分多少列显示
     *
     ...
     *
     * 这个值类似于spanCount尽量不用，item的宽度应该为屏幕的宽度根据spanCount进行平分
     *
     ...
     *
     * 图片加载器，需要使用放自行提供图片的加载 可以是glide也可以是Picasso
     *
     ...
     *
     * 只有{@link #originalEnable}设置为true的时候才有效 当用户点击原图回调
     *
     * @param listener {@link OnSelectedListener}
     * @return {@link SelectionCreator} for fluent API.
     */
